...
async function init() {
  try {
    ...
    const { createSfera, sendMessage, invokeAvrora, addMember, forkSfera } =
    ...
    if (!apiKey) {
      console.error(
        "❌ Error: Set AVRORA_API_KEY or MCP_API_KEY environment variable"
      );
    ...
    const [user] = await db
      ...
      .where(
        require("drizzle-orm").eq(
          require("../lib/db/schema.js").user.id,
          apiKeyRecord.userId
        )
      )
      .limit(1);
            ...
            case "resources/read": {
              ...
              if (uri === "sfera://list") {
                ...
                if (parts.length === 1) {
                  ...
                  resource = await getSferaMessages(
                    sferaId,
                    user.id,
                    params.limit,
                    params.offset
                  ...
                  },
                  {
                    ...
                    inputSchema: {
                      ...
                      properties: {
                        ...
                        messageId: {
                          type: "string",
                          description: "Message ID to fork",
                        },
                        title: {
                          type: "string",
                          description: "New Sfera title",
                        },
                        description: {
                          type: "string",
