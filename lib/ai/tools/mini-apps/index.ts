/**
 * AVRORA: Mini-App Tools
 *
 * Lightweight tools for creating interactive artifacts inside a Sfera discussion
 * without calling external APIs (fast, deterministic stubs that can be enhanced later).
 */
